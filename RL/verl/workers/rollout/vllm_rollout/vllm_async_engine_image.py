...
from verl.utils.dataset.task_prompt import ERROR_INFO_MULTI_TURN_PROMPT, TOOL_CALL_CROP_MULTI_TRUN_PROMPT
...
class AsyncvLLMEngine:
    ...
    def process_tool_call(self, vllm_input, decoded_resp_, observations_list, image_size_used_list, multi_turn_response_mask, current_iteration, doc_id):
        error_info = None
        try:
    ...
    async def _async_rollout_a_request(
        ...
        while current_iteration < max_iterations:
            ...
            if len(tool_call_contents) > 0:
                ...
                new_context_length, tool_outputs = await loop.run_in_executor(None, lambda: self.process_tool_call(vllm_input, decoded_resp_, observations_list, image_size_used_list, multi_turn_response_mask, current_iteration, doc_id))
